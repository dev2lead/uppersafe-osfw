...
|`server`|In this mode, the firewall dumps the threats, after processing them, to a file (`assets/threats.txt`) intended to be shared through an HTTP(S) server and fetched by the client|
